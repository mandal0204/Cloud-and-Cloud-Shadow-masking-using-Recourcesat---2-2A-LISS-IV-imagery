...
WIDTH_MULTIPLIER = 0.50  # Reduce model complexity
LEARNING_RATE = 1e-3
NUM_CLASSES = 3
CLASS_NAMES = ['BACKGROUND', 'CLOUD', 'SHADOW']

# ======================= FOCAL LOSS IMPLEMENTATION =======================
def focal_loss(gamma=2.0, alpha=[0.05, 0.35, 0.6]):
...
def build_unet(input_shape=(PATCH_SIZE, PATCH_SIZE, 3), num_classes=NUM_CLASSES, width_multiplier=WIDTH_MULTIPLIER):
...
if __name__ == "__main__":
    ...
    MODEL_PATH = "/home/btech1/isro/models/optimized_unet.keras"
    ...
    model = tf.keras.models.load_model(
        MODEL_PATH,
        custom_objects={
            'focal_loss_fn': focal_loss(gamma=2.0, alpha=[0.05, 0.35, 0.6]),
